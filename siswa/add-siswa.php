                        ...
                        <div class="row">
                            ...
                            <div class="col-8">
                                ...
                                <div class="mb-3 row">
                                    ...
                                    <label class="col-sm-1 col-form-label">:</label>
                                    <div class="col-sm-9" style="margin-left: -50px;">
                                        <input type="text" name="nama" required class="form-control-plaintext border-bottom" id="nama">
                                    </div>
                                </div>
                                <div class="mb-3 row">
                            ...
                            <div class="col-4 text-center px-5">
                                <img src="../asset/image/default-user.png" alt="Foto" class="mb-3 img-thumbnail" width="120">
