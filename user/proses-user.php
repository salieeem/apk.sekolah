...
if (isset($_POST['simpan'])) {
    ...
    // ❗ INSERT yang benar, TIDAK ADA "null" disini
    mysqli_query($koneksi, "INSERT INTO tbl_user (username, password, nama, jabatan, alamat, foto) 
                            VALUES ('$username', '$pass', '$nama', '$jabatan', '$alamat', '$foto')")
