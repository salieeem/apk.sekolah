                ...
                <div class="card-body">
                    <div class="row">
                        ...
                        <div class="col-4 text-center px-5">
                            <img src="../asset/image/Salinan default.png" alt="Foto User" class="img-thumbnail mb-3" style="width: 60%; object-fit: cover;">

                            <div class="mb-2">
                                <input type="file" name="image" class="form-control form-control-sm">
                            </div>

                            <small class="text-muted d-block">Pilih foto PNG, JPG atau JPEG ukuran maksimal 1 MB</small>
                        </div>
                    </div>
