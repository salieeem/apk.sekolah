                    ...
                    <div class="card">
                        ...
                        <div class="card-body">
                            <div class="d-flex justify-content-between">
                                ...
                                $no = $start + 1;
                                $keyword = @$_GET['cari'];
                                $queryPelajaran = mysqli_query($koneksi, "SELECT * FROM tbl_pelajaran WHERE pelajaran LIKE '%$keyword%' or kelas LIKE '%$keyword%' or guru LIKE '%$keyword%' limit $page offset $start");

                                $queryJmlData = mysqli_query($koneksi, "SELECT * FROM tbl_pelajaran WHERE pelajaran LIKE '%$keyword%' or kelas LIKE '%$keyword%' or guru LIKE '%$keyword%'");
